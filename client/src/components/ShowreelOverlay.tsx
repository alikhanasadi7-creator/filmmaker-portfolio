/* ============================================================= 
   ...
   Appears at bottom of Home page with cinematic easing
   ============================================================= */
import { useEffect, useState } from "react";

export default function ShowreelOverlay() {
  ...
  useEffect(() => {
    ...
    return () => {
      window.removeEventListener("homeScrollProgress", handleScrollProgress);
  ...
  if (scrollProgress >= triggerPoint) {
    const animationProgress = Math.min(
      (scrollProgress - triggerPoint) / animationRange,
      1
    );
  ...
  return (
    ...
    >
      <div
        className="fixed bottom-0 left-0 right-0 min-h-screen bg-background pointer-events-auto"
        style={{
      ...
      >
        ...
        <section className="pt-24 md:pt-32 lg:pt-40 pb-12 md:pb-16 lg:pb-20 px-6 md:px-12 lg:px-24">
          <div className="max-w-2xl">
            ...
            >
              A selection of recent work spanning documentary, branded content,
